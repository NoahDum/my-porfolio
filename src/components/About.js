    ...
    <div>
      ...
      <div className="contain container">
        ...
        <div>
          ...
          <p>Je sais coder dans plusieurs language évidemment mais je vais pas te spoil ! Si tu veux savoir lesquels fonce dans la section <Link to="/skill"> Mes compétences</Link>.</p>
        </div>
      </div>
    </div>
  )
